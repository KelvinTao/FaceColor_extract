...
def getCondition(light,iris,minus):
	...
	''' wangsj_XJ, second run
	if (light>90 and iris <30) or (light>150 and iris <35):
		condition='strong-dark';# 57,15#
		irisThresh=57;pupilThresh=15;pad=8;
	elif (light>200 and iris <45): 
		condition='strong-dark';
		...
		pupilThresh=15;irisThresh=95;pad=0;#90
	'''
	#condition4_2
